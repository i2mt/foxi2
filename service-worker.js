...
const CACHE_NAME = 'FoxiMed_v5.0.36';
...
const urlsToCache = [
    ...
    './index.html',
    './style.css?v=38',
    './voice-assistant.css?v=38',
    './calculation-core.js?v=34',
    './script.js?v=38',
    './voice-engine-policy.js?v=38',
    './voice-recognition.js?v=38',
    './koochik-asr.js?v=35',
    './koochik-worker.js?v=34',
    './whisper-asr.js?v=38',
    './whisper-worker.js?v=38',
    './sherpa-koochik/sherpa-onnx-asr.js',
    './sherpa-koochik/sherpa-onnx-vad.js',
    './sherpa-koochik/sherpa-onnx-wasm-main-vad-asr.js',
    './voice-commands.js?v=38',
    './voice-ui.js?v=38',
    './converters.js',
    './drugDatabase.js',
    './manifest.json',
