Warning: truncated output (original token count: 74908)
Total output lines: 6064
...
// ============================================
function setupSettingsEventListeners() …24908 tokens truncated….open').forEach(openItem => {
        if (openItem !== item) {
