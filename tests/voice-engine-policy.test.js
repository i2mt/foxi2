...
assert.strictEqual(policy.choose({ mode: 'auto', hasWebGPU: true, deviceMemory: 8 }), 'rizeh');
assert.strictEqual(policy.choose({ mode: 'auto', hasWebGPU: true, deviceMemory: 4 }), 'rizeh');
assert.strictEqual(policy.choose({ mode: 'auto', hasWebGPU: true }), 'rizeh');
...
assert.strictEqual(policy.choose({ mode: 'unexpected', hasWebGPU: true, deviceMemory: 8 }), 'rizeh');
