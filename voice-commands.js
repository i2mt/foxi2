...
(function (window) {
    ...
    const SMALL_TALK = {
        ...
        'کی تورو ساخت|کی ساخته|سازنده|کی نوشته|برنامه نویس|خالقت کیه|خالقت چیه|کی تورو خلق کرد|کی خلقت کرد|خالق تو کیه|ساخته شدی|ساخته شده ای|توسط کی ساخته': [
            'فاکسی‌مد رو یک پرستار ساخته تا ابزارهای پراکنده و محاسبات روزمره را یک‌جا جمع کند.',
            'توسعه‌دهنده فاکسی‌مد از همکاران پرستاره و برنامه را بر اساس نیازهای واقعی محیط درمان ساخته.'
        ],
        ...
        'شلوغه|شلوغ|پرکاره|پرکار': [
            'می‌فهمم. کارها رو طبق اولویت بالینی و روال بخش یکی‌یکی پیش ببر؛ من هم برای محاسبات آماده‌ام.',
            'باشه؛ کوتاه بگو چه ابزاری لازم داری تا مستقیم بازش کنم.'
        ],
        ...
        'گشنمه|تشنمه|گرسنمه|تشنه ام|گرسنه ام|گشنه ام': [
            'اگر فرصت شد، برای آب یا یک خوراکی کوتاه وقت بگذار.',
            'حواست به خودت هم باشه؛ امیدوارم زود فرصت استراحت پیدا کنی.'
        ],
