...
const drugDatabase = {
    heparin: {
        ...
        alternativeNames: ['هپارین سدیم', 'Heparin', 'Hepflush', 'هپارین'],
        icon: 'fas fa-tint',
        color: '#667eea',
    ...
    furosemide: {
        ...
        alternativeNames: ['لازیکس', 'Lasix', 'Frusemide', 'فروزماید', 'فورزماید', 'لازیک', 'فروز ماید'],
        icon: 'fas fa-water',
        color: '#f093fb',
    ...
    insulin: {
        ...
        alternativeNames: ['انسولین معمولی', 'Humulin R', 'Actrapid', 'انسولین'],
        icon: 'fas fa-syringe',
        color: '#ff6b6b',
        category: 'Hormone',
        defaultAmpoules: 1,
    ...
    fentanyl: {
        ...
        alternativeNames: ['سوبلیماز', 'Sublimaze', 'Duragesic', 'فنتانیل'],
    ...
    pantoprazole: {
        ...
        alternativeNames: ['پروتونیکس', 'Protonix', 'Pantoloc', 'پانتوپرازول', 'پنتو پرا زول', 'پانتو پرا زول'],
        icon: 'fas fa-tablets',
        color: '#5ac8fa',
        category: 'PPI',
        defaultAmpoules: 2,
    ...
    nitroglycerin: {
        ...
        alternativeNames: ['نیتروگلیسیرین تزریقی', 'Nitrostat', 'Nitro-Bid', 'TNG', 'تی ان جی', 'نیترو'],
    ...
    norepinephrine: {
        ...
        alternativeNames: ['لوووفد', 'Levophed', 'Noradrenaline', 'نورآدرنالین', 'نور آدرنالین'],
    ...
    midazolam: {
        ...
        alternativeNames: ['ورسید', 'Versed', 'Hypnovel', 'میدازولام'],
        icon: 'fas fa-bed',
        color: '#764ba2',
    ...
    octreotide: {
        ...
        alternativeNames: ['ساندوستاتین', 'Sandostatin', 'اکترئوتاید'],
    ...
    labetalol: {
        ...
        alternativeNames: ['تراندیت', 'Trandate', 'Normodyne', 'لابتالول'],
        icon: 'fas fa-heart',
        color: '#4facfe',
    ...
    dopamine: {
        ...
        alternativeNames: ['اینوتروپ', 'Dopastat', 'Intropin', 'دوپامین'],
        icon: 'fas fa-heartbeat',
        color: '#ff4081',
        category: 'Inotrope',
        defaultAmpoules: 1,
    ...
    amiodarone: {
        ...
        alternativeNames: ['کوردارون', 'Cordarone', 'Pacerone', 'آمیودارون'],
        icon: 'fas fa-heartbeat',
        color: '#4CAF50',
    ...
    lidocaine: {
        ...
        alternativeNames: ['لیگنوکائین', 'Lignocaine', 'Xylocaine', 'لیدوکائین'],
        icon: 'fas fa-bolt',
        color: '#7c3aed',
        category: 'Antiarrhythmic',
        defaultAmpoules: 2,
    ...
    dobutamine: {
        ...
        alternativeNames: ['دوبوترکس', 'Dobutrex', 'Inotrex', 'دوبوتامین'],
        icon: 'fas fa-heart-pulse',
        color: '#e11d48',
        category: 'Inotrope',
        defaultAmpoules: 1,
