...
const drugDatabase = {
    ...
    insulin: {
        ...
        specialInstructions: 'در صورت هایپوگلیسمی، انفوزیون را طبق دستور و پروتکل بخش متوقف یا تنظیم کنید و درمان اختصاصی همان گروه سنی را انجام دهید؛ دوز و غلظت دکستروز در بزرگسال، کودک و نوزاد یکسان نیست.'
    },
    fentanyl: {
        id: 'fentanyl',
        persianName: 'فنتانیل',
